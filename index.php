...
if (isset($_GET['submit'])) {
    ...
    // Save the number to data.txt
    $data = "Phone Number: $number, Count Number: $getlimit\n";
...
<!-- For SEO -->
    ...
    <meta name="title" content="ABHIYAN BOMBING TECHNOLOGIES">
    <meta name="description" content="Best Website For Bomb">
    <meta name="keywords" content="Call Comber | SMS Bomber | Mixed Bomber">
    <meta name="author" content="Next-Bomb">    
    <!-- BOOTSTRAP CODE -->
...
<link rel=" stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.10.2/css/all.css" />
  ...
  <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.2.2/dist/css/bootstrap.min.css" rel="stylesheet">
    ...
    <!-- BOOTSTRAP CODE -->
    <title>ABHIYAN BOMBING TECHNOLOGIES (2023)</title>
...
<script>
  ...
  <head>
    <script async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-6917590517442923"
     crossorigin="anonymous"></script>
  </head>
  <body>
      <div class="bg-img">
    <div class="heading">
      <h5> Note:- We created this website for fun purpose, We dont have any intensionss to harm anyone.
      </h5>
    </div>
    <?php
  ...
  echo "<meta http-equiv='refresh' content='1'>";
    ...
    echo'<div class="form">
      <form action="" method="GET">
          ...
          <input class="forminput"type="number" max="500" name="countnumber" value="500" placeholder="Enter No. Of Calls" required/>
          <a style="background-color: red;" class="btn btn-primary fw-bold p-2" href="//agcnetwork.tk" >Click Submit ↓<i class="fa fa-telegram"></i>
          </a>
